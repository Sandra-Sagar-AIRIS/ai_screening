...
class InterviewService:
    ...
    def create_interview(self, organization_id: UUID, payload: InterviewCreate) -> Interview:
        self._pipelines.get_pipeline_by_id(payload.pipeline_id, organization_id)
    ...
    def get_interview_by_id(self, interview_id: UUID, organization_id: UUID) -> Interview:
    ...
    def update_interview(
        ...
        interview = self.get_interview_by_id(interview_id, organization_id)
        ...
        if "pipeline_id" in update_data:
            ...
            self._pipelines.get_pipeline_by_id(new_pipeline_id, organization_id)
