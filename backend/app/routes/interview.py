...
def create_interview(
    ...
    interview = service.create_interview(UUID(current_user.organization_id), payload)
...
def get_interview(
    ...
    service = InterviewService(db)
    interview = service.get_interview_by_id(interview_id, UUID(current_user.organization_id))
    return InterviewResponse.model_validate(interview)
